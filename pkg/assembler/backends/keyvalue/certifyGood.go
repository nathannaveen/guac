...
func (c *demoClient) CertifyGoodList(ctx context.Context, certifyGoodSpec model.CertifyGoodSpec, after *string, first *int) (*model.CertifyGoodConnection, error) {
	...
	var search []string
	foundOne := false
	if &certifyGoodSpec != nil && certifyGoodSpec.Subject != nil && certifyGoodSpec.Subject.Artifact != nil {
	...
	if !foundOne && &certifyGoodSpec != nil && certifyGoodSpec.Subject != nil && certifyGoodSpec.Subject.Source != nil {
