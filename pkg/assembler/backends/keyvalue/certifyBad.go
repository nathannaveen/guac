...
func (c *demoClient) CertifyBadList(ctx context.Context, certifyBadSpec model.CertifyBadSpec, after *string, first *int) (*model.CertifyBadConnection, error) {
	...
	var search []string
	foundOne := false
	if &certifyBadSpec != nil && certifyBadSpec.Subject != nil && certifyBadSpec.Subject.Artifact != nil {
	...
	if !foundOne && &certifyBadSpec != nil && certifyBadSpec.Subject != nil && certifyBadSpec.Subject.Source != nil {
